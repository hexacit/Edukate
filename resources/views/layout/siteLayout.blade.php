...
<head>
    <meta charset="utf-8">
    <title>Edukate - @yield('title')</title>
        ...
        <div class="container mt-5 pt-5">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <a class="text-white-50 mb-2" href="{{route('pages','praivcy')}}"><i class="fa fa-angle-right mr-2"></i>Privacy Policy</a>
                        <a class="text-white-50 mb-2" href="{{route('pages','terms')}}"><i class="fa fa-angle-right mr-2"></i>Terms & Condition</a>
                        <a class="text-white-50 mb-2" href="{{route('pages','faqs')}}"><i class="fa fa-angle-right mr-2"></i>Regular FAQs</a>
                        <a class="text-white-50 mb-2" href="{{route('pages','help')}}"><i class="fa fa-angle-right mr-2"></i>Help & Support</a>
